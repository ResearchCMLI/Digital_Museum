	...
	<div class="section" style="margin-top:50px;">
		<div class="container">
			<div class="row text-left mb-4">
				<div class="col-12">
					<h2 class="font-weight-bold heading text-primary mb-5">About Porifera</h2>
				</div>
				<div class="col-lg-6">
<p class="text-black-50"style="text-align:justify;font-size:20px;">They are parasites or free-living. 
The cells of Poriferans are loosely organized.  They are mostly found in marine water. 
Only a few are found in freshwater. They are either radially symmetrical or asymmetrical. 
Their body is usually cylindrical. 
The scleroblast secretes spicules while spongin fibres are secreted by spongioblasts. 
They have no organs in their body. They depict cellular grade of organization. </p>
<p class="text-black-50"style="text-align:justify;font-size:20px;">The body comprises numerous pores known as Ostia and osculum. 
The central cavity is called spongocoel or atrium which opens to the outside through the osculum. 
They reproduce asexually by budding, and fragmentation. The nutrition is holozoic. 
...
They have the power to regenerate the lost parts.
 ...
 The exchange of respiratory gases and nitrogenous wastes occurs by the process of diffusion. </p> 
					
				</div>
				<div class="col-lg-6 mb-5 mb-lg-0">
					<div class="img-about dots">
						<img src="images/porifera.jpg" alt="Image" class="img-fluid">
					</div>
				</div>
			</div>
						...
						<div class="property-slider">
							...
							<div class="property-item">
								...
								<a href="\Museumnn/pages/animal/leucosolenia.php" class="img">
									<img src="images/porifera/leucosolenia.jpg" alt="Image" class="img-fluid">
								</a>
								...
								<!--	<div class="price mb-2"><span>$1,291,000</span></div> -->
									<div>
										...
										<span class="city d-block mb-3">LEUCOSOLENIA </span>
										
										<span class="d-block mb-2 text-black-50" style="text-align:justify;">
										Leucosolenia, genus of tubular branched sponges of the class Calcispongiae (phylum Porifera). 
										Species of this genus usually appear as groups of curved vases  
										</span> 
										...
										<a href="\Museumnn/pages/animal/leucosolenia.php" class="btn btn-primary py-2 px-3">More...</a>
									</div>
								</div>
							</div> <!-- .item -->
