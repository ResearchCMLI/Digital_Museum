	...
	<div class="section" style="margin-top:50px;">
		<div class="container">
			<div class="row text-left mb-4">
				<div class="col-12">
					<h2 class="font-weight-bold heading text-primary mb-5">About Amphibian</h2>
				</div>
				<div class="col-lg-6">
<p class="text-black-50"style="text-align:justify;font-size:20px;">These are cold-blooded or poikilothermal animals.
These are cold-blooded or poikilothermal animals.
	They undergo hibernation or aestivation.
	The body is divided into the head and trunk.
	The amphibian skin is moist, smooth, and scales less.
	Their mouth is bigger, and teeth are pleurodont, homodont, and polyphyodont.
	Their mouth is bigger, and teeth are pleurodont, homodont, and polyphyodont.

 </p>
<p class="text-black-50"style="text-align:justify;font-size:20px;">These can live both on land and in water.
	...
	They have no paired fins.
				...
				<div class="col-lg-6 mb-5 mb-lg-0">
					<div class="img-about dots">
						<img src="images/Amphibian2.jpeg" alt="Image" class="img-fluid">
					</div>
				</div>
			</div>
						...
						<div class="property-slider">
							...
							<div class="property-item">
								...
								<a href="\Museumnn/pages/animal/axolotl.php" class="img">
									...
									<img src="images/amphibians/AXOLOTL.jpg" alt="Image" class="img-fluid">
								</a>
								...
								<!--	<div class="price mb-2"><span>$1,291,000</span></div> -->
									<div>
										...
										<span class="city d-block mb-3">Axolotl</span>
										...
										<a href="\Museumnn/pages/animal/axolotl.php" class="btn btn-primary py-2 px-3">More...</a>
									</div>
								</div>
							</div> <!-- .item -->
							<div class="property-item">
								...
								<a href="\Museumnn/pages/animal/frog.php" class="img">
									...
									<img src="images/amphibians/frog.jpg" alt="Image" class="img-fluid">
								</a>
								...
								<!--	<div class="price mb-2"><span>$1,291,000</span></div> -->
									<div>
										...
										<span class="city d-block mb-3">Life Cycle of Frog</span>
										
										<span class="d-block mb-2 text-black-50" style="text-align:justify;">
										The wide-ranging frogs of order anura, containing several genera snd more than 600 species.Representatives occur on every continent except Antarctica.	
										</span> 
										...
										<a href="\Museumnn/pages/animal/frog.php" class="btn btn-primary py-2 px-3">More...</a>
									</div>
								</div>
							</div> <!-- .item -->
							<div class="property-item">
								...
								<a href="\Museumnn/pages/animal/toad.php" class="img">
									...
									<img src="images/amphibians/toad1.jpg" alt="Image" class="img-fluid">
								</a>
								...
								<!--	<div class="price mb-2"><span>$1,291,000</span></div> -->
									<div>
										...
										<span class="city d-block mb-3">Toad</span>
										
										<span class="d-block mb-2 text-black-50" style="text-align:justify;">
										The common toad can reach about 15 cm (6 in) in length. Females are normally stouter than males and southern specimens tend to be larger than northern  
										</span> 
										...
										<a href="\Museumnn/pages/animal/toad.php" class="btn btn-primary py-2 px-3">More...</a>
									</div>
								</div>
							...
							<div class="property-item">
								...
								<a href="\Museumnn/pages/animal/ura.php" class="img">
									
									<img src="images/amphibians/Uraeotyphlus4.jpg" alt="Image" class="img-fluid">
								</a>
								...
								<!--	<div class="price mb-2"><span>$1,291,000</span></div> -->
									<div>
										...
										<span class="city d-block mb-3">Uraeotyphlus</span>
										
										<span class="d-block mb-2 text-black-50" style="text-align:justify;">
										The size of Uraeotyphlus caecilians ranges from 23 centimetres to 35 centimetres, making them quite tiny. 
										</span> 
										...
										<a href="\Museumnn/pages/animal/ura.php" class="btn btn-primary py-2 px-3">More...</a>
									</div>
								</div>
							...
							<div class="property-item">
								...
								<a href="\Museumnn/pages/animal/viscera.php" class="img">
									
									<img src="images/amphibians/viscera of frog 4.jpg" alt="Image" class="img-fluid">
								</a>
								...
								<!--	<div class="price mb-2"><span>$1,291,000</span></div> -->
									<div>
										...
										<span class="city d-block mb-3">Viscera</span>
										...
										<a href="\Museumnn/pages/animal/viscera.php" class="btn btn-primary py-2 px-3">More...</a>
									</div>
								</div>
