	...
	<div class="section" style="margin-top:50px;">
		<div class="container">
			<div class="row text-left mb-4">
				<div class="col-12">
					<h2 class="font-weight-bold heading text-primary mb-5">About Aves</h2>
				</div>
				<div class="col-lg-6">
<p class="text-black-50"style="text-align:justify;font-size:20px;">Aves is a taxonomic group that includes all the birds.
	Usually, the birds with feathers and wings are classified under Aves and simultaneously play an important role within the environment and mainly in terms of maintaining biodiversity.
	The birds are warm-blooded animals.
	Their forelimbs are modified into wings.

 </p>
<p class="text-black-50"style="text-align:justify;font-size:20px;">They have well-developed flight muscles that help during the flight.
	...
	Most of the birds are oviparous in nature.
				...
				<div class="col-lg-6 mb-5 mb-lg-0">
					<div class="img-about dots">
						<img src="images/Aves2.jpeg" alt="Image" class="img-fluid">
					</div>
				</div>
			</div>
						...
						<div class="property-slider">
							...
							<div class="property-item">
								...
								<a href="\Museumnn/pages/animal/blue.php" class="img">
									...
									<img src="images/aves/bluejay1.jpg" alt="Image" class="img-fluid">
								</a>
								...
								<!--	<div class="price mb-2"><span>$1,291,000</span></div> -->
									<div>
										...
										<span class="city d-block mb-3">Blue Jay</span>
										
										<span class="d-block mb-2 text-black-50" style="text-align:justify;">
										It is predominantly blue, with a white chest and a blue crest. It has black, U shaped collar around its neck and a black border behind the crest. 	
										</span> 
										...
										<a href="\Museumnn/pages/animal/blue.php" class="btn btn-primary py-2 px-3">More...</a>
									</div>
								</div>
							</div> <!-- .item -->
							<div class="property-item">
								...
								<a href="\Museumnn/pages/animal/crane.php" class="img">
									...
									<img src="images/aves/Crane4.jpg" alt="Image" class="img-fluid">
								</a>
								...
								<!--	<div class="price mb-2"><span>$1,291,000</span></div> -->
									<div>
										...
										<span class="city d-block mb-3">Crane</span>
										
										<span class="d-block mb-2 text-black-50" style="text-align:justify;">
										Cranes are large, long-legged, and long-necked birds in the group Gruiformes.  	Cranes are tall birds with long legs, necks and usually long bills. 
										</span> 
										...
										<a href="\Museumnn/pages/animal/crane.php" class="btn btn-primary py-2 px-3">More...</a>
									</div>
								</div>
							</div> <!-- .item -->
							<div class="property-item">
								...
								<a href="\Museumnn/pages/animal/duck.php" class="img">
									...
									<img src="images/aves/duck.png" alt="Image" class="img-fluid">
								</a>
								...
								<!--	<div class="price mb-2"><span>$1,291,000</span></div> -->
									<div>
										...
										<span class="city d-block mb-3">Duck</span>
										...
										<a href="\Museumnn/pages/animal/duck.php" class="btn btn-primary py-2 px-3">More...</a>
									</div>
								</div>
							</div> <!-- .item -->
							<div class="property-item">
								...
								<a href="\Museumnn/pages/animal/kingfisher.php" class="img">
									...
									<img src="images/aves/king.jpg" alt="Image" class="img-fluid">
								</a>
								...
								<!--	<div class="price mb-2"><span>$1,291,000</span></div> -->
									<div>
										...
										<span class="city d-block mb-3">Kingfisher</span>
										
										<span class="d-block mb-2 text-black-50" style="text-align:justify;">
										All kingfishers have large heads, long, sharp, pointed bills, short legs, and stubby tails. Cranes are tall birds with long legs, necks and usually long bills.   	
										</span> 
										...
										<a href="\Museumnn/pages/animal/kingfisher.php" class="btn btn-primary py-2 px-3">More...</a>
									</div>
								</div>
							</div> <!-- .item -->
							<div class="property-item">
								...
								<a href="\Museumnn/pages/animal/sparrow.php" class="img">
									...
									<img src="images/aves/sparrow.jpg" alt="Image" class="img-fluid">
								</a>
								...
								<!--	<div class="price mb-2"><span>$1,291,000</span></div> -->
									<div>
										...
										<span class="city d-block mb-3">Sparrow</span>
										
										<span class="d-block mb-2 text-black-50" style="text-align:justify;">
										Sparrows have beautiful voices and their chirping and singing can be heard all over.Other unique characteristics are their smooth, round heads    	
										</span> 
										...
										<a href="\Museumnn/pages/animal/sparrow.php" class="btn btn-primary py-2 px-3">More...</a>
									</div>
								</div>
							</div> <!-- .item -->
							<div class="property-item">
								...
								<a href="\Museumnn/pages/animal/woodpecker.php" class="img">
									...
									<img src="images/aves/wood.jpg" alt="Image" class="img-fluid">
								</a>
								...
								<!--	<div class="price mb-2"><span>$1,291,000</span></div> -->
									<div>
										...
										<span class="city d-block mb-3">Woodpecker</span>
										
										<span class="d-block mb-2 text-black-50" style="text-align:justify;">
										Woodpecker range from tiny piculets, the smallest from 7.5cm to the largest can be more than 50 cm in length.   	
										</span> 
										...
										<a href="\Museumnn/pages/animal/woodpecker.php" class="btn btn-primary py-2 px-3">More...</a>
									</div>
								</div>
							</div> <!-- .item -->
