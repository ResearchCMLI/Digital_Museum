	...
	<div class="section" style="margin-top:50px;">
		<div class="container">
			<div class="row text-left mb-4">
				<div class="col-12">
					<h2 class="font-weight-bold heading text-primary mb-5">About Mammals</h2>
				</div>
				<div class="col-lg-6">
<p class="text-black-50"style="text-align:justify;font-size:20px;">Mammals are one of the most evolved species in the animal kingdom.
	...
	Mammals are warm-blooded animals that give birth to their young.
	They are the most common mammals.

 </p>
<p class="text-black-50"style="text-align:justify;font-size:20px;">They are the most prevalent animal form; they can be found in almost all types of habitats.
	The presence of the Neocortex, a region of the brain that is known for its creativity.
	The cervical vertebrae are also present in mammals.
	The skull has a dicondylic shape.
				...
				<div class="col-lg-6 mb-5 mb-lg-0">
					<div class="img-about dots">
						<img src="images/Mammals1.jpeg" alt="Image" class="img-fluid">
					</div>
				</div>
			</div>
						...
						<div class="property-slider">
							...
							<div class="property-item">
								...
								<a href="\Museumnn/pages/animal/bat.php" class="img">
									...
									<img src="images/mammals/bat 3.jpg" alt="Image" class="img-fluid">
								</a>
								...
								<!--	<div class="price mb-2"><span>$1,291,000</span></div> -->
									<div>
										...
										<span class="city d-block mb-3">Bat</span>
										
										<span class="d-block mb-2 text-black-50" style="text-align:justify;">
										There are the only mammals capable of true flight, that is, flight powered by muscular movement as distinct from gliding. 
										</span> 
										...
										<a href="\Museumnn/pages/animal/bat.php" class="btn btn-primary py-2 px-3">More...</a>
									</div>
								</div>
							</div> <!-- .item -->
							<div class="property-item">
								...
								<a href="\Museumnn/pages/animal/hedgehog.php" class="img">
									...
									<img src="images/mammals/hedge.jpg" alt="Image" class="img-fluid">
								</a>
								...
								<!--	<div class="price mb-2"><span>$1,291,000</span></div> -->
									<div>
										...
										<span class="city d-block mb-3">Hedgehog</span>
										
										<span class="d-block mb-2 text-black-50" style="text-align:justify;">
										Most hedgehogs are 6-8 inches in length, but it is hard to accurately and consistently measure a hedgehog because their body changes shape    	
										</span> 
										...
										<a href="\Museumnn/pages/animal/hedgehog.php" class="btn btn-primary py-2 px-3">More...</a>
									</div>
								</div>
							</div> <!-- .item -->
							<div class="property-item">
								...
								<a href="\Museumnn/pages/animal/pangolin.php" class="img">
									...
									<img src="images/mammals/pangolin.jpg" alt="Image" class="img-fluid">
								</a>
								...
								<!--	<div class="price mb-2"><span>$1,291,000</span></div> -->
									<div>
										...
										<span class="city d-block mb-3">Pangolin</span>
										...
										<a href="\Museumnn/pages/animal/pangolin.php" class="btn btn-primary py-2 px-3">More...</a>
									</div>
								</div>
							</div> <!-- .item -->
							<div class="property-item">
								...
								<a href="\Museumnn/pages/animal/rabbit.php" class="img">
									...
									<img src="images/mammals/rabbit.jpg" alt="Image" class="img-fluid">
								</a>
								...
								<!--	<div class="price mb-2"><span>$1,291,000</span></div> -->
									<div>
										...
										<span class="city d-block mb-3">Rabbit Embryo</span>
										...
										<a href="\Museumnn/pages/animal/rabbit.php" class="btn btn-primary py-2 px-3">More...</a>
									</div>
								</div>
							</div> <!-- .item -->
							<div class="property-item">
								...
								<a href="\Museumnn/pages/animal/squirrel.php" class="img">
									...
									<img src="images/mammals/squirrel.jpg" alt="Image" class="img-fluid">
								</a>
								...
								<!--	<div class="price mb-2"><span>$1,291,000</span></div> -->
									<div>
										...
										<span class="city d-block mb-3">Squirrel Embryo</span>
										
										<span class="d-block mb-2 text-black-50" style="text-align:justify;">
											Squirrels includes medium sized or small rodents.
The complete squirrel family includes tree squirrels, ground squirrels, chipmunks, flying squirrels
										...
										<a href="\Museumnn/pages/animal/squirrel.php" class="btn btn-primary py-2 px-3">More...</a>
									</div>
								</div>
							</div> <!-- .item -->
							<div class="property-item">

								<a href="\Museumnn/pages/animal/sheep.php" class="img">
									
									<img src="images/mammals/sheep.jpg" alt="Image" class="img-fluid">
								</a>
								...
								<!--	<div class="price mb-2"><span>$1,291,000</span></div> -->
									<div>
										...
										<span class="city d-block mb-3">Sheep Embryo</span>
										
										<span class="d-block mb-2 text-black-50" style="text-align:justify;">
											Sheep or domestic sheep (Ovis aries) are domesticated, ruminant mammals kept as livestock. The term sheep can apply to other species in the genus Ovis
										</span> 
										...
										<a href="\Museumnn/pages/animal/sheep.php" class="btn btn-primary py-2 px-3">More...</a>
									</div>
								</div>
							</div> <!-- .item -->
