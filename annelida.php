	...
	<div class="section" style="margin-top:50px;">
		<div class="container">
			<div class="row text-left mb-4">
				<div class="col-12">
					<h2 class="font-weight-bold heading text-primary mb-5">About Annelida</h2>
				</div>
				<div class="col-lg-6">
<p class="text-black-50"style="text-align:justify;font-size:20px;">The Annelids are coelomate and triploblastic.
...
<p class="text-black-50"style="text-align:justify;font-size:20px;">Their body contains haemoglobin, which gives them a red colour.
...
Most of the Annelids are hermaphrodite, i.e., male and female organs are present in the same body. They reproduce both sexually and asexually. The others reproduce sexually.
				...
				<div class="col-lg-6 mb-5 mb-lg-0">
					<div class="img-about dots">
						<img src="images/annelida.png" alt="Image" class="img-fluid">
					</div>
				</div>
			</div>
						...
						<div class="property-slider">
							...
							<div class="property-item">
								...
								<a href="\Museumnn/pages/animal/arenicola.php" class="img">
									<img src="images/annelida/Arenicola 4.jpg" alt="Image" class="img-fluid">
								</a>
								...
								<!--	<div class="price mb-2"><span>$1,291,000</span></div> -->
									<div>
										...
										<span class="city d-block mb-3">ARENICOLA </span>
										
										<span class="d-block mb-2 text-black-50" style="text-align:justify;">
										Body is stout, elongated, cylindrical and approximately 15 cm long, brownish or greenish in colour and divided into metameres.<br>
										...
										<a href="\Museumnn/pages/animal/arenicola.php" class="btn btn-primary py-2 px-3">More...</a>
									</div>
								</div>
							</div> <!-- .item -->
							...
							<div class="property-item">
								...
								<a href="\Museumnn/pages/animal/chaetopterus.php" class="img">
									<img src="images/annelida/chaetopterus.jpg" alt="Image" class="img-fluid">
								</a>
								...
								<!--	<div class="price mb-2"><span>$1,291,000</span></div> -->
									<div>
										...
										<span class="city d-block mb-3">CHAETOPTERUS</span>
										 
								<span class="d-block mb-2 text-black-50" style="text-align:justify;">
								It is a tube – dwelling, marine and bioluminescent annelid. 
								It is commonly called as paddle worm having greatly modified segments.   </span> 
										...
										<a href="\Museumnn/pages/animal/chaetopterus.php" class="btn btn-primary py-2 px-3">More...</a>
									</div>
								</div>
							</div> <!-- .item -->
							...
							<div class="property-item">
								...
								<a href="\Museumnn/pages/animal/marphysa.php" class="img">
									<img src="images/annelida/marphysa.jpg" alt="Image" class="img-fluid">
								</a>

								<div class="property-content">
									<!-- <div class="price mb-2"><span>$1,291,000</span></div> -->
									<div>
										<span class="city d-block mb-3">MARPHYSA</span>
										
										<span class="d-block mb-2 text-black-50" style="text-align:justify;">
										The Prostomium bilobed, with two small eyes. 
										It has five antennae, short, smooth or indistinctly annulated.  
										The peristomium is two to three times longer  
										</span>
										...
										<a href="\Museumnn/pages/animal/marphysa.php" class="btn btn-primary py-2 px-3">More...</a>
									</div>
								</div>
							</div> <!-- .item -->
							...
							<div class="property-item">
								...
								<a href="\Museumnn/pages/animal/sabella.php" class="img">
									<img src="images/annelida/sabella.jpg" alt="Image" class="img-fluid"> 
								</a>

								<div class="property-content">
									<!-- <div class="price mb-2"><span>$1,291,000</span></div> -->
									<div>
										<span class="city d-block mb-3">SABELLA</span>
										<span class="d-block mb-2 text-black-50" style="text-align:justify;">
										The body may reach 30 cm and include as many as 600 segments. 
										The body is protected by a tube with a diameter of 8 mm or less. 
										  </span>
									...
									<!--	<div class="specs d-flex mb-4">
										...
										<a href="\Museumnn/pages/animal/sabella.php" class="btn btn-primary py-2 px-3">More...</a>
									</div>
								</div>
							</div> <!-- .item -->
							<div class="property-item">
								...
								<a href="\Museumnn/pages/animal/terebella.php" class="img">
									<img src="images/annelida/terebella.jpg" alt="Image" class="img-fluid"> 
								</a>

								<div class="property-content">
									<!-- <div class="price mb-2"><span>$1,291,000</span></div> -->
									<div>
										<span class="city d-block mb-3">TEREBELLA</span>
										<span class="d-block mb-2 text-black-50" style="text-align:justify;">
										The body is elongated, cylindrical and divided into head and trunk. The head is horseshoe-shaped, made up of prostomium and peristomium.   </span>
									...
									<!--	<div class="specs d-flex mb-4">
										...
										<a href="\Museumnn/pages/animal/terebella.php" class="btn btn-primary py-2 px-3">More...</a>
									</div>
								</div>
							</div> <!-- .item -->
							<div class="property-item">

								<a href="\Museumnn/pages/animal/eunice.php" class="img">
									<img src="images/annelida/Eunice1.jpg" alt="Image" class="img-fluid"> 
								</a>

								<div class="property-content">
									<!-- <div class="price mb-2"><span>$1,291,000</span></div> -->
									<div>
										<span class="city d-block mb-3">Eunice</span>
										<span class="d-block mb-2 text-black-50" style="text-align:justify;">
										The polychaete genus Eunice is belongs to the Eunicidae family.The size of an individual can range from 0.5 to 300 cm (0.20 and 118.11 in).  </span>
									...
									<!--	<div class="specs d-flex mb-4">
										...
										<a href="\Museumnn/pages/animal/eunice.php" class="btn btn-primary py-2 px-3">More...</a>
									</div>
								</div>
							</div> <!-- .item -->
							<div class="property-item">

								<a href="\Museumnn/pages/animal/polyneo.php" class="img">
									<img src="images/annelida/polynoe.jpg" alt="Image" class="img-fluid"> 
								</a>

								<div class="property-content">
									<!-- <div class="price mb-2"><span>$1,291,000</span></div> -->
									<div>
										<span class="city d-block mb-3">Polynoe</span>
										<span class="d-block mb-2 text-black-50" style="text-align:justify;">
										Most of these species are short in nature but some can reach up to 20 cm in length and 10 cm width. It has distinct head and its body comprises of 12-15  </span>
									...
									<!--	<div class="specs d-flex mb-4">
										...
										<a href="\Museumnn/pages/animal/polyneo.php" class="btn btn-primary py-2 px-3">More...</a>
									</div>
								</div>
							</div> <!-- .item -->
