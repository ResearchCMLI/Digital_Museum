	...
	<div class="section" style="margin-top:50px;">
		<div class="container">
			<div class="row text-left mb-4">
				<div class="col-12">
					<h2 class="font-weight-bold heading text-primary mb-5">About Platyhelminthes</h2>
				</div>
				<div class="col-lg-6">
<p class="text-black-50"style="text-align:justify;font-size:20px;">They are triploblastic, acoelomate, and bilaterally symmetrical.
...
<p class="text-black-50"style="text-align:justify;font-size:20px;">They reproduce sexually by fusion of gametes and asexually by regeneration by fission and regeneration.
...
The nervous system comprises the brain and two longitudinal nerve cords arranged in a ladder-like fashion.
				...
				<div class="col-lg-6 mb-5 mb-lg-0">
					<div class="img-about dots">
						<img src="images/platy.jpg" alt="Image" class="img-fluid">
					</div>
				</div>
			</div>
						...
						<div class="property-slider">
							...
							<div class="property-item">
								...
								<a href="\Museumnn/pages/animal/planaria.php" class="img">
									<img src="images/platyhelminthis/Planaria 3.jpg" alt="Image" class="img-fluid">
								</a>
								...
								<!--	<div class="price mb-2"><span>$1,291,000</span></div> -->
									<div>
										...
										<span class="city d-block mb-3">PLANARIA</span>
										
										<span class="d-block mb-2 text-black-50" style="text-align:justify;">
										They are triploblastic, acoelomate, and bilaterally symmetrical. They may be free-living or parasites. 
										The body has a soft covering with or without cilia.
										</span> 
										...
										<a href="\Museumnn/pages/animal/planaria.php" class="btn btn-primary py-2 px-3">More...</a>
									</div>
								</div>
							</div> <!-- .item -->
							<div class="property-item">
								...
								<a href="\Museumnn/pages/animal/tapeworm.php" class="img">
									<img src="images/platyhelminthis/tape.jpg" alt="Image" class="img-fluid">
								</a>
								...
								<!--	<div class="price mb-2"><span>$1,291,000</span></div> -->
									<div>
										...
										<a href="\Museumnn/pages/animal/tapeworm.php" class="btn btn-primary py-2 px-3">More...</a>
									</div>
								</div>
							</div> <!-- .item -->
