	...
	<div class="section" style="margin-top:50px;">
		<div class="container">
			<div class="row text-left mb-4">
				<div class="col-12">
					<h2 class="font-weight-bold heading text-primary mb-5">About Protozoa</h2>
				</div>
				<div class="col-lg-6">
<p class="text-black-50"style="text-align:justify;font-size:20px;">They are parasites or free-living. 
...
The contractile vacuole is present in the amoeboids living in freshwater. </p>
<p class="text-black-50"style="text-align:justify;font-size:20px;">Reproduction is by binary fission and cyst formation.
...
Reproduction is by sporozoite formation. </p> 
					
				</div>
				<div class="col-lg-6 mb-5 mb-lg-0">
					<div class="img-about dots">
						<img src="images/protozoa.jpg" alt="Image" class="img-fluid">
					</div>
				</div>
			</div>
						...
						<div class="property-slider">
							...
							<div class="property-item">
								...
								<a href="\Museumnn/pages/animal/amoeba.php" class="img">
									<img src="images/protozoa/amoeba1.jpg" alt="Image" class="img-fluid">
								</a>
								...
								<!--	<div class="price mb-2"><span>$1,291,000</span></div> -->
									<div>
										...
										<span class="city d-block mb-3">AMOEBA </span>
										
										<span class="d-block mb-2 text-black-50" style="text-align:justify;">
										Amoeba proteus is widely distributed and commonly found on the bottom mud or on
										the underside of aquatic vegetation in freshwater, ponds, ditches, lakes 
										</span> 
										...
										<a href="\Museumnn/pages/animal/amoeba.php" class="btn btn-primary py-2 px-3">More...</a>
									</div>
								</div>
							</div> <!-- .item -->
							...
							<div class="property-item">
								...
								<a href="\Museumnn/pages/animal/euglena.php" class="img">
									<img src="images/protozoa/euglena1.jpg" alt="Image" class="img-fluid">
								</a>
								...
								<!--	<div class="price mb-2"><span>$1,291,000</span></div> -->
									<div>
										...
										<span class="city d-block mb-3">EUGLENA</span>
										 
								<span class="d-block mb-2 text-black-50" style="text-align:justify;">
								The members of Euglena usually live in fresh and brackish water habitats such as ponds rich in
								organic matter and some even in marine waters.   </span> 
										...
										<a href="\Museumnn/pages/animal/euglena.php" class="btn btn-primary py-2 px-3">More...</a>
									</div>
								</div>
							</div> <!-- .item -->
							...
							<div class="property-item">
								...
								<a href="\Museumnn/pages/animal/paramecium.php" class="img">
									<img src="images/protozoa/paramecium1.jpg" alt="Image" class="img-fluid">
								</a>

								<div class="property-content">
									<!-- <div class="price mb-2"><span>$1,291,000</span></div> -->
									<div>
										<span class="city d-block mb-3">PARAMECIUM</span>
										
										<span class="d-block mb-2 text-black-50" style="text-align:justify;">
										Paramecium has a worldwide distribution and is a free-living organism. 
										It usually lives in the stagnant water of pools, lakes, ditches, ponds and slow
										flowing 
										</span>
										...
										<a href="\Museumnn/pages/animal/paramecium.php" class="btn btn-primary py-2 px-3">More...</a>
									</div>
								</div>
							</div> <!-- .item -->
							...
							<div class="property-item">
								...
								<div class="property-content">
									...
									<div>
										...
										occurs worldwide, especially in tropical and temperate 
								  </span>
