	...
	<div class="section" style="margin-top:50px;">
		<div class="container">
			<div class="row text-left mb-4">
				<div class="col-12">
					<h2 class="font-weight-bold heading text-primary mb-5">About Mollusca</h2>
				</div>
				<div class="col-lg-6">
<p class="text-black-50"style="text-align:justify;font-size:20px;">They are mostly found in marine and freshwater. Very few are terrestrial and found in moist soil.
...
<p class="text-black-50"style="text-align:justify;font-size:20px;">They have a well-developed digestive system, the radula is the rasping organ for feeding.
...
They are generally oviparous with indirect development.
				...
				<div class="col-lg-6 mb-5 mb-lg-0">
					<div class="img-about dots">
						<img src="images/mollusca.jpg" alt="Image" class="img-fluid">
					</div>
				</div>
			</div>
						...
						<div class="property-slider">
							...
							<div class="property-item">
								...
								<a href="\Museumnn/pages/animal/conus.php" class="img">
									<img src="images/mollusca/conus.jpg" alt="Image" class="img-fluid">
								</a>
								...
								<!--	<div class="price mb-2"><span>$1,291,000</span></div> -->
									<div>
										...
										<span class="city d-block mb-3">CONUS </span>
										...
										<a href="\Museumnn/pages/animal/conus.php" class="btn btn-primary py-2 px-3">More...</a>
									</div>
								</div>
							</div> <!-- .item -->
							...
							<div class="property-item">
								...
								<a href="\Museumnn/pages/animal/ostrea.php" class="img">
									<img src="images/mollusca/ostrea.jpg" alt="Image" class="img-fluid">
								</a>
								...
								<!--	<div class="price mb-2"><span>$1,291,000</span></div> -->
									<div>
										...
										<span class="city d-block mb-3">OSTREA</span>
										 
								<span class="d-block mb-2 text-black-50" style="text-align:justify;">
								They are commonly called as edible oyster. 
								Shell valves are irregular and variable in shape. 
								Very thick and often with folded layers. 
								  </span> 
										...
										<a href="\Museumnn/pages/animal/ostrea.php" class="btn btn-primary py-2 px-3">More...</a>
									</div>
								</div>
							</div> <!-- .item -->
							...
							<div class="property-item">
								...
								<a href="\Museumnn/pages/animal/patella.php" class="img">
									<img src="images/mollusca/patella.jpg" alt="Image" class="img-fluid">
								</a>

								<div class="property-content">
									<!-- <div class="price mb-2"><span>$1,291,000</span></div> -->
									<div>
										<span class="city d-block mb-3">PATELLA VULGATA</span>
										...
										<a href="\Museumnn/pages/animal/patella.php" class="btn btn-primary py-2 px-3">More...</a>
									</div>
								</div>
							</div> <!-- .item -->
							...
							<div class="property-item">
								...
								<a href="\Museumnn/pages/animal/pearl.php" class="img">
									<img src="images/mollusca/pearl.jpg" alt="Image" class="img-fluid"> 
								</a>

								<div class="property-content">
									<!-- <div class="price mb-2"><span>$1,291,000</span></div> -->
									<div>
										<span class="city d-block mb-3">PEARL OYSTER</span>
										<span class="d-block mb-2 text-black-50" style="text-align:justify;">
										It is commonly called as Indian pearl oyster. 
										The Shell valves are unequal and the hinge line is straight, produced at each end into a short ear    </span>
									...
									<!--	<div class="specs d-flex mb-4">
										...
										<a href="\Museumnn/pages/animal/pearl.php" class="btn btn-primary py-2 px-3">More...</a>
									</div>
								</div>
							</div> <!-- .item -->
							<div class="property-item">
								...
								<a href="\Museumnn/pages/animal/turritella.php" class="img">
									<img src="images/mollusca/turritella.jpg" alt="Image" class="img-fluid">
								</a>

								<div class="property-content">
									<!-- <div class="price mb-2"><span>$1,291,000</span></div> -->
									<div>
										<span class="city d-block mb-3">TURRITELA</span>
										<span class="d-block mb-2 text-black-50" style="text-align:justify;">
										The tall, conical shell is brownish-yellow to white. It is sharply pointed and contains 16-20 enlarged whorls. 
										The spiral ridges are numerous (with 3 – 6 more prominent)   </span>
									...
									<!--	<div class="specs d-flex mb-4">
										...
										<a href="\Museumnn/pages/animal/turritella.php" class="btn btn-primary py-2 px-3">More...</a>
									</div>
								</div>
							</div> <!-- .item -->
							<div class="property-item">

								<a href="\Museumnn/pages/animal/arca.php" class="img">
									<img src="images/mollusca/arca.png" alt="Image" class="img-fluid">
								</a>

								<div class="property-content">
									<!-- <div class="price mb-2"><span>$1,291,000</span></div> -->
									<div>
										<span class="city d-block mb-3">ARCA</span>
										<span class="d-block mb-2 text-black-50" style="text-align:justify;">
										Some species in Arca, such as Arca zebra and Arca have  a brown  and  white  stripes   pattern . Arca attach themselves to rock with byssal threads  </span>
									...
									<!--	<div class="specs d-flex mb-4">
										...
										<a href="\Museumnn/pages/animal/arca.php" class="btn btn-primary py-2 px-3">More...</a>
									</div>
								</div>
							</div> <!-- .item -->
							<div class="property-item">

								<a href="\Museumnn/pages/animal/ariophant.php" class="img">
									<img src="images/mollusca/ariophant.jpg" alt="Image" class="img-fluid">
								</a>

								<div class="property-content">
									<!-- <div class="price mb-2"><span>$1,291,000</span></div> -->
									<div>
										<span class="city d-block mb-3">ARIOPHANT</span>
										<span class="d-block mb-2 text-black-50" style="text-align:justify;">
										Ariophanta laevipes is a species of air-breathing landsnail,a terrestrial pulmonate gastropod mollusc inthe family Ariophantidae.   </span>
									...
									<!--	<div class="specs d-flex mb-4">
										...
										<a href="\Museumnn/pages/animal/ariophant.php" class="btn btn-primary py-2 px-3">More...</a>
									</div>
								</div>
							</div> <!-- .item -->
							<div class="property-item">

								<a href="\Museumnn/pages/animal/octopus.php" class="img">
									<img src="images/mollusca/Octopus 3.jpg" alt="Image" class="img-fluid">
								</a>

								<div class="property-content">
									<!-- <div class="price mb-2"><span>$1,291,000</span></div> -->
									<div>
										<span class="city d-block mb-3">OCTOPUS</span>
										<span class="d-block mb-2 text-black-50" style="text-align:justify;">
										Octopus is a genus of cephalopod mollusc in the order Octopoda. They have two, large eyes and eight limbs with suckers.   </span>
									...
									<!--	<div class="specs d-flex mb-4">
										...
										<a href="\Museumnn/pages/animal/octopus.php" class="btn btn-primary py-2 px-3">More...</a>
									</div>
								</div>
							</div> <!-- .item -->
							<div class="property-item">

								<a href="\Museumnn/pages/animal/vaginulus.php" class="img">
									<img src="images/mollusca/vaginulus.jpg" alt="Image" class="img-fluid">
								</a>

								<div class="property-content">
									<!-- <div class="price mb-2"><span>$1,291,000</span></div> -->
									<div>
										<span class="city d-block mb-3">VAGINULUS</span>
										<span class="d-block mb-2 text-black-50" style="text-align:justify;">
										Vaginulus is the species of the air – breathing and slugs, shell -less terrestrial pulmonate gastropod molluscks in the family Veronicellidae    </span>
									...
									<!--	<div class="specs d-flex mb-4">
										...
										<a href="\Museumnn/pages/animal/vaginulus.php" class="btn btn-primary py-2 px-3">More...</a>
									</div>
								</div>
							</div> <!-- .item -->
